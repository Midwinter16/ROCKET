...
- todo
  ...
  - 任务类型过滤
  - 设置类似彩虹桥项目中的表单
    - 表单过长时限制在可视区域内，不要超出可视区高度
    - 设置更高一层的 Form 封装，参考彩虹桥
    - 设置表单的三种状态，分别为 CREATE、EDIT 和 VIEW，然后通过 withViewMode 来设置表单的值状态，而不是通过检测表单状态来将输入框设置为 disabled，不美观
- 设置
  - 主体颜色切换
- 银行 app 界面
- 个人博客
